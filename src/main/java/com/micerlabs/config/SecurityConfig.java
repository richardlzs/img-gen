...
//                //defaultSuccessUrl登录成功跳转的页面,如果直接到Login页面登陆成功跳转的地址
        ...
        manager.createUser(User.withUsername("test01").password("123456+").authorities("test").build());
        manager.createUser(User.withUsername("test222").password("123456+").authorities("test").build());
